    ...
    <div className="space-y-6">
      <div className="text-left">
        ...
        <p className="text-muted-foreground text-sm mt-1">
          Customize your profile, configure account passwords, or manage account safety.
        </p>
      </div>
                ...
                <CardContent className="space-y-4 pt-6 text-left">
                  {profileSuccess && (
                    <div className="mb-4 flex items-center gap-2 rounded-lg bg-emerald-500/10 p-3 text-sm text-emerald-600 dark:text-emerald-500 border border-emerald-500/20 animate-fade-in">
                      ...
                      <span className="text-xs font-semibold">{profileSuccess}</span>
                    </div>
                  )}
                  ...
                  <div className="space-y-2">
                    <label htmlFor="profName" className="text-sm font-semibold text-foreground">
                      Full Name
                    </label>
                    <Input
                      id="profName"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="profEmail" className="text-sm font-semibold text-foreground">
                      Email Address
                    </label>
                    <Input
                      id="profEmail"
                  ...
                  <Button type="submit" disabled={updateProfileMutation.isPending} className="cursor-pointer">
          ...
          {activeTab === "password" && (
            <Card className="border-border bg-card">
              <CardHeader className="text-left pb-4 border-b border-border">
                ...
                <CardDescription>Improve your safety credentials with a strong password.</CardDescription>
              </CardHeader>
              <form onSubmit={handlePasswordChange}>
                <CardContent className="space-y-4 pt-6 text-left">
                  ...
                  <div className="space-y-2">
                    <label htmlFor="currPass" className="text-sm font-semibold text-foreground">
                      Current Password *
                    </label>
                    <Input
                      id="currPass"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="newPass" className="text-sm font-semibold text-foreground">
                      New Password *
                    </label>
                    <Input
                      id="newPass"
          ...
          {activeTab === "danger" && (
            <Card className="border-destructive/20 bg-destructive/5">
              <CardHeader className="text-left pb-4 border-b border-destructive/10">
                ...
                <CardDescription>High risk operations. Please read notes carefully.</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4 pt-6 text-left">
                {deleteError && (
                  <div className="mb-4 flex items-center gap-2 rounded-lg bg-destructive/10 p-3 text-sm text-destructive border border-destructive/20 animate-fade-in">
                ...
                <div className="space-y-2">
                  <h4 className="font-bold text-sm text-foreground">Delete Account Permanent</h4>
                  <p className="text-xs text-muted-foreground">
                    This will permanently delete your account, remove your associations from all teams, and log you out.
