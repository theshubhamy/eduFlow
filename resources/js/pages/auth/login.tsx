...
export default function Login({
    ...
    return (
        <AuthSplitLayout
            title="Welcome back"
            description="Enter your credentials to access your school dashboard"
        >
            <Head title="Log in" />
            ...
            <div className="grid gap-6">
                        ...
                        <>
                            <div className="grid gap-5">
                                ...
                                <div className="flex items-center space-x-3">
                                    <Checkbox
                                        ...
                                        name="remember"
                                        tabIndex={3}
                                        className="rounded-md border-zinc-300 text-indigo-600 focus:ring-indigo-600"
                                    />
                            ...
                            <div className="relative my-2">
                                ...
                                <div className="relative flex justify-center text-xs uppercase">
                                    <span className="bg-white px-2 text-zinc-500 dark:bg-background dark:text-zinc-400">
                                        Or continue with
                                    </span>
                                </div>
                            </div>
                            ...
                            {canRegister && (
                                <div className="mt-4 text-center text-sm text-zinc-600 dark:text-zinc-400">
                                    New to EduFlow?{' '}
                                    <TextLink href={register()} className="font-semibold text-indigo-600 hover:text-indigo-500" tabIndex={5}>
                                        Create an account
                                    </TextLink>
                                </div>
                            )}
                ...
                {status && (
                    <div className="rounded-xl bg-emerald-50 p-4 text-center text-sm font-medium text-emerald-600 dark:bg-emerald-950/30 dark:text-emerald-400">
                        {status}
                    </div>
                )}
            </div>
