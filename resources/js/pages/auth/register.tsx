...
export default function Register() {
    return (
        <AuthCardLayout 
            ...
            description="Join EduFlow today and start managing your school with ease"
        >
            <Head title="Register" />
            <Form
                {...store.form()}
                ...
                {({ processing, errors }) => (
                    <>
                        <div className="grid gap-5">
                            ...
                            <Button
                                type="submit"
                                className="mt-4 h-11 rounded-xl bg-indigo-600 font-semibold text-white transition-all hover:bg-indigo-700 hover:shadow-lg hover:shadow-indigo-200 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:hover:shadow-none"
                                tabIndex={5}
                        ...
                        <div className="relative my-2">
                            ...
                            <div className="relative flex justify-center text-xs uppercase">
                                <span className="bg-white px-10 text-zinc-500 dark:bg-background dark:text-zinc-400">
                                    Or register with
                                </span>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <Button variant="outline" type="button" className="h-11 rounded-xl border-zinc-200 transition-colors hover:bg-zinc-50 dark:border-zinc-800 dark:hover:bg-zinc-900">
                        ...
                        <div className="mt-4 text-center text-sm text-zinc-600 dark:text-zinc-400">
                            Already a member?{' '}
                            <TextLink href={login()} className="font-semibold text-indigo-600 hover:text-indigo-500" tabIndex={6}>
                                Sign in
                            </TextLink>
                        </div>
                    </>
